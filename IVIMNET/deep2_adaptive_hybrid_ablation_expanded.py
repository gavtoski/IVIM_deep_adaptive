...
def constraint_prior_func(tissue_type="mixed", model_type="3C", custom_dict=None):
    ...
    if tissue_type == "mixed":
        ...
        if model_type == "2C":
            return {
                "Dpar": expand_range((0.00065, 0.00075)),
                "Dmv":  expand_range((0.010, 0.025)),
                "Fmv":  expand_range((0.03, 0.06))
            }
        elif model_type == "3C":
            prior = {
                "Dpar":  expand_range((0.00050, 0.00074)),
                "Dint":  expand_range((0.00212, 0.0030)),
                "Dmv":   expand_range((0.0736, 0.10)),
                "Fint":  expand_range((0.0584, 0.08)),
                "Fmv":   expand_range((0.0048, 0.008)),
                "Ftotal": (None, 0.75)
            }
        ...
        if model_type == "2C":
            return {
                "Dpar": expand_range((0.00055, 0.00065)),
                "Dmv":  expand_range((0.007, 0.015)),
                "Fmv":  expand_range((0.06, 0.10)) #lowered to the orignal range
            }
        elif model_type == "3C":
            prior = {
